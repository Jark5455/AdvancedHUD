...
public class HudItemExperienceBar extends HudItem {
    ...
    public boolean isRenderedInCreative() {
        return Minecraft.getMinecraft().thePlayer.capabilities.isCreativeMode && (Minecraft.getMinecraft().currentScreen instanceof GuiAdvancedHUDConfiguration || Minecraft.getMinecraft().currentScreen instanceof GuiScreenReposition);
    }
