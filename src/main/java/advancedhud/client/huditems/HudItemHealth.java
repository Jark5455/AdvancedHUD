...
public class HudItemHealth extends HudItem {
    ...
    public void render(float partialTicks) {
        ...
        boolean flag = this.healthUpdateCounter > (long)mc.ingameGUI.getUpdateCounter() && (this.healthUpdateCounter - (long)this.mc.ingameGUI.getUpdateCounter()) / 3L % 2L == 1L;

        if (health < this.playerHealth && mc.thePlayer.hurtResistantTime > 0)
        {
            this.lastSystemTime = Minecraft.getSystemTime();
            this.healthUpdateCounter = this.mc.ingameGUI.getUpdateCounter() + 20L;
        }
        else if (health > this.playerHealth && mc.thePlayer.hurtResistantTime > 0)
        {
            this.lastSystemTime = Minecraft.getSystemTime();
            this.healthUpdateCounter = this.mc.ingameGUI.getUpdateCounter() + 10L;
        }
        ...
        int healthLast = MathHelper.ceiling_float_int(this.lastPlayerHealth);
        ...
        this.rand.setSeed(mc.ingameGUI.getUpdateCounter() * 312871L);
